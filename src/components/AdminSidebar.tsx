...
const navItems: NavItem[] = [
    ...
    { label: "Admins", to: "/admin/manage-admins", icon: <Shield size={20} /> },
    ...
    return (
        ...
        `}
            >
                ...
                {/* Navigation Links */}
                <div className="flex-1 overflow-y-auto py-6 px-3 space-y-2 scrollbar-thin scrollbar-thumb-slate-200 dark:scrollbar-thumb-slate-700">
                    {navItems.map((item) => (
